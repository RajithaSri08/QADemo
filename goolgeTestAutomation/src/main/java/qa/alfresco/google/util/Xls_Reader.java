...
public class Xls_Reader {
	public static String filename = System.getProperty("user.dir") + "//data//GoogleResults.xlsx";
	public String path;
	...
	private XSSFCell cell = null;
		...
		public static void main(String arg[]) throws IOException {
			...
			datatable = new Xls_Reader(
					"/Users/sridhar/projects/RajithaPractice/Flipkart_Hybrid_Framework/data/SessionSuiteA.xlsx");
			for (int col = 0; col < datatable.getColumnCount("TC5"); col++) {
				System.out.println(datatable.getCellData("TC5", col, 1));
			}
		}

		public String setCellData(String sheetName, int i, int rowNum, String data) {
